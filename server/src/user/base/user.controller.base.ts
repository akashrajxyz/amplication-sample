...
export class UserControllerBase {
  ...
  async findManyOrganisationsNo(
    ...
    const results = await this.service.findOrganisationsNo(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/organisationsNo")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async createOrganisationsNo(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Patch("/:id/organisationsNo")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async updateOrganisationsNo(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Delete("/:id/organisationsNo")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async deleteOrganisationsNo(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: UserWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
